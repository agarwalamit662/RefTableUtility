...
DELETE FROM RT_FIELD_VALUES WHERE REF_TABLE_FIELD_ID IN (SELECT REF_TABLE_FIELD_ID FROM RT_TABLE_FIELD WHERE REF_TABLE_ID IN (SELECT REF_TABLE_ID FROM RT_TABLE WHERE NAME = 'MEDICALEXPENSEVRF' ))
DELETE FROM RT_TABLE_FIELD WHERE REF_TABLE_ID IN (SELECT REF_TABLE_ID FROM RT_TABLE WHERE NAME = 'MEDICALEXPENSEVRF' )
DELETE FROM RT_TABLE WHERE NAME = 'MEDICALEXPENSEVRF'
