...
DELETE FROM RT_FIELD_VALUES WHERE REF_TABLE_FIELD_ID IN (SELECT REF_TABLE_FIELD_ID FROM RT_TABLE_FIELD WHERE REF_TABLE_ID IN (SELECT REF_TABLE_ID FROM RT_TABLE WHERE NAME = 'ALIENSTATUSDATEVRF' ))
DELETE FROM RT_TABLE_FIELD WHERE REF_TABLE_ID IN (SELECT REF_TABLE_ID FROM RT_TABLE WHERE NAME = 'ALIENSTATUSDATEVRF' )
DELETE FROM RT_TABLE WHERE NAME = 'ALIENSTATUSDATEVRF'
...
INSERT INTO [dbo].[RT_FIELD_VALUES]([REF_TABLE_FIELD_ID],[FIELD_ROW_ID],[FIELD_VALUE],[CREATE_USER_ID],[UPDATE_USER_ID],[CREATE_DT],[UPDATE_DT],[UNIQUE_TRANS_ID],[ARCHIVE_DT]) VALUES (@ref_table_field_id_1 ,@ref_field_row_id_2 ,'CS','Amit.Agarwal','Amit.Agarwal',GETDATE(),GETDATE(),NEXT VALUE FOR RT_FIELD_VALUES_0SQ,'2999-12-31 00:00:00')
INSERT INTO [dbo].[RT_FIELD_VALUES]([REF_TABLE_FIELD_ID],[FIELD_ROW_ID],[FIELD_VALUE],[CREATE_USER_ID],[UPDATE_USER_ID],[CREATE_DT],[UPDATE_DT],[UNIQUE_TRANS_ID],[ARCHIVE_DT]) VALUES (@ref_table_field_id_2 ,@ref_field_row_id_2 ,'Client Statement','Amit.Agarwal','Amit.Agarwal',GETDATE(),GETDATE(),NEXT VALUE FOR RT_FIELD_VALUES_0SQ,'2999-12-31 00:00:00')
